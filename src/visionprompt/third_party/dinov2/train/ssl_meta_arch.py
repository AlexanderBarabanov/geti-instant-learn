...
from ..utils.param_groups import fuse_params_groups, get_params_groups_with_decay
    ...
    def update_teacher(self, m):
        ...
        with torch.no_grad():
            for k in self.student.keys():
                for ms, mt in zip(
                    get_fsdp_modules(self.student[k]), get_fsdp_modules(self.teacher[k]), strict=False,
                ):
