...
class ImageNet(ExtendedVisionDataset):
    ...
    def _get_entries_path(self, split: "ImageNet.Split", root: str | None = None) -> str:
        return f"entries-{split.value.upper()}.npy"

    def _get_class_ids_path(self, split: "ImageNet.Split", root: str | None = None) -> str:
        return f"class-ids-{split.value.upper()}.npy"

    def _get_class_names_path(self, split: "ImageNet.Split", root: str | None = None) -> str:
    ...
    def get_target(self, index: int) -> _Labels | None:
    ...
    def _dump_entries(self, split: "ImageNet.Split", root: str | None = None) -> None:
    ...
    def _dump_class_ids_and_names(self, split: "ImageNet.Split", root: str | None = None) -> None:
        if split == ImageNet.Split.TEST:
            return
    ...
    def dump_extra(self, split: "ImageNet.Split", root: str | None = None) -> None:
