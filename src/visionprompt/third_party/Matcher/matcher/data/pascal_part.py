...
class DatasetPASCALPart(Dataset):
    def __init__(self, datapath, fold, transform, split, shot, use_original_imgsize, box_crop=True):
        ...
        js = json.load(open(self.json_file))
    ...
    def sample_episode(self, idx):
        ...
        while True:
            ...
            anno = json.load(open(self.anno_file.format(query_img_id)))
        ...
        while True:  # keep sampling support set if query == support
            ...
            while True:
                ...
                anno = json.load(open(self.anno_file.format(support_img_id)))
        ...
        if self.box_crop:
            ...
            for sup_img, sup_mask, sup_box in zip(support_imgs, support_masks, support_boxes, strict=False):
