...
class SamAutomaticMaskGenerator:
    ...
    def generate(
        self,
        image: np.ndarray,
        select_point_coords: list[np.ndarray] | None = None,
        select_point_labels: list[np.ndarray] | None = None,
        select_box: np.ndarray | None = None,
        select_mask_input: np.ndarray | None = None,
    ) -> list[dict[str, Any]]:
    ...
    def _process_crop(
        ...
        select_point_coords: list[np.ndarray] | None = None,
        select_point_labels: list[np.ndarray] | None = None,
        select_boxs: list[np.ndarray] | None = None,
        select_masks_input: list[np.ndarray] | None = None,
    ) -> MaskData:
        ...
        if crop_layer_idx == 0 and select_point_coords is not None:
            ...
            for select_point_coords, select_point_labels, select_box, select_mask_input in \
                    zip(select_point_coords, select_point_labels, select_boxs, select_masks_input, strict=False):
