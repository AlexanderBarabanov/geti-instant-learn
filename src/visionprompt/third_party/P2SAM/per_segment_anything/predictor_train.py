...
class SamPredictorTr:
    ...
    def set_torch_image(
        ...
        if transformed_mask is not None:
          input_mask = self.model.preprocess_mask(transformed_mask)  # pad to 1024 [debug] preprocess -> preprocess_mask
          return input_mask
    ...
    def predict(
        ...
        masks, iou_predictions, low_res_masks, high_res_masks, src_embedding, upscaled_embedding = self.predict_torch(
            coords_torch,
            labels_torch,
            box_torch,
            mask_input_torch,
        ...
        return masks, iou_predictions, low_res_masks, high_res_masks, src_embedding, upscaled_embedding
    ...
    def predict_torch(
        ...
        # Predict masks
        low_res_masks, iou_predictions, src_embedding, upscaled_embedding = self.model.mask_decoder(
        ...
        if not return_logits:
            ...
            return masks, iou_predictions, low_res_masks, high_res_masks, src_embedding, upscaled_embedding
        return high_res_masks, iou_predictions, low_res_masks, high_res_masks, src_embedding, upscaled_embedding
