...
def load_image_from_dir(
    ...
    return_mode="path",
    k: int | None = None,
    shuffle_func: Callable | None = None,
...
class CustomImageFolder(ImageFolder):
    def __init__(
        self, root: str, transform: Callable | None = None, return_dict: bool = False,
    ):
...
class ImageDataset(Dataset):
    def __init__(
        ...
        splits: str | list[str | None] | None = None,
        ...
        self.samples = []
        for data_dir, split in zip(self.data_dirs, self.splits, strict=False):
            if split is None:
