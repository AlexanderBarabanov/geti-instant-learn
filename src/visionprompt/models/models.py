...
from visionprompt.models.per_segment_anything import SamPredictor, sam_model_registry
from visionprompt.utils import download_file, precision_to_torch_dtype
from visionprompt.utils.constants import DATA_PATH, MODEL_MAP, SAMModelName

if TYPE_CHECKING:
    from segment_anything_hq.modeling.sam import Sam as SamHQ

    from visionprompt.models.per_segment_anything.modeling.sam import Sam
