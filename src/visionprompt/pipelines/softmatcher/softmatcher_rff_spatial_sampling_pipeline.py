"""SoftMatcherRFFSpatialSampling pipeline."""
...
class SoftMatcherRFFSpatialSampling(Matcher):
    """This is the SoftMatcherRFFSpatialSampling pipeline.

    This pipeline is the same as the SoftMatcherRFF pipeline, but it uses spatial sampling to generate prompts.

    Examples:
        >>> from visionprompt.pipelines.softmatcher import SoftMatcherRFFSpatialSampling
        ...
        >>> soft_matcher = SoftMatcherRFFSpatialSampling(sam_predictor=sam_predictor)
        >>> # Create mock inputs
    ...
    def __init__(
        ...
        """Initialize the SoftMatcherRFFSpatialSampling pipeline."""
        super().__init__(
