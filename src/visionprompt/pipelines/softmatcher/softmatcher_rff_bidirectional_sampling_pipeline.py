"""SoftMatcherRFFBiDirectionalSampling pipeline."""
...
class SoftMatcherRFFBiDirectionalSampling(Matcher):
    """This is the SoftMatcherRFFBiDirectionalSampling pipeline.

    This pipeline is the same as the SoftMatcherRFFBiDirectional pipeline, but it uses sampling.

    Examples:
        >>> from visionprompt.pipelines.softmatcher import SoftMatcherRFFBiDirectionalSampling
        ...
        >>> soft_matcher = SoftMatcherRFFBiDirectionalSampling(sam_predictor=sam_predictor)
        >>> # Create mock inputs
    ...
    def __init__(
        ...
        """Initialize the SoftMatcherRFFBiDirectionalSampling pipeline."""
        super().__init__(
