"""SoftMatcherRFFBiDirectionalSpatialSampling pipeline."""
...
class SoftMatcherRFFBiDirectionalSpatialSampling(Matcher):
    """This is the SoftMatcherRFFBiDirectionalSpatialSampling pipeline.

    This pipeline is the same as the SoftMatcherBiDirectionalSpatialSampling pipeline, but it uses RFF.

    Examples:
        >>> from visionprompt.pipelines.softmatcher import SoftMatcherRFFBiDirectionalSpatialSampling
        ...
        >>> soft_matcher = SoftMatcherRFFBiDirectionalSpatialSampling(sam_predictor=sam_predictor)
        >>> # Create mock inputs
    ...
    def __init__(
        ...
        """Initialize the SoftMatcherRFFBiDirectionalSpatialSampling pipeline."""
        super().__init__(
