"""SoftMatcherBiDirectionalSampling pipeline."""
...
class SoftMatcherBiDirectionalSampling(Matcher):
    """This is the SoftMatcherBiDirectionalSampling pipeline.

    This pipeline is the same as the SoftMatcherBiDirectional pipeline, but it uses sampling to generate prompts.
