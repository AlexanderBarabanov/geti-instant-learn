...
class Priors(Data):
    """
    This class represents priors for a single image. These can contain points, boxes, masks or polygons.
    They mainly serve as input for Segmentation models.
    """

    def __init__(
        self,
        points: Optional[Points] = None,
        boxes: Optional[Prompt] = None,
        masks: Optional[Masks] = None,
        polygons: Optional[Prompt] = None,
    ):
