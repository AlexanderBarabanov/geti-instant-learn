...
class Prompt(Data):
    """
    This class represents a prompt for a single image. This can be points, boxes or polygons.
    It serves as a base class for masks.
    """

    def __init__(self, data: Optional[dict[int, torch.Tensor | np.ndarray]] = None):
        self._data: dict[int, torch.Tensor | np.ndarray] = (
